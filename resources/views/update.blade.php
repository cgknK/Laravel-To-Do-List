                ...
                <div class="container">
                    <form action="{{route("notes.update", $note->id)}}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="remember" value="{{$note->user->name }}" readonly disabled>
                        </div>
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $("#flexSwitchCheckDefault").change(function() {
                        ...
                        @endif
                        <button type="submit" class="btn btn-warning bg-warning"><i class="bi bi-floppy"></i></button>
